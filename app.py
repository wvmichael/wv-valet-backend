...
VERDICT (do not restate this — it's shown to the user separately)
{verdict}

WEATHER DATA
{weather_block}

Write the paragraph now. Remember: 2-4 sentences, plain English, no venue specifics, no greeting or sign-off.
"""
...
def forecast_explain():
    ...
    paragraph = _call_gemini(EXPLAINER_SYSTEM_PROMPT, user_message)
    used_ai = paragraph is not None
    if not paragraph:
